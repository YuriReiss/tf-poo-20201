 ...
 * @author yuri-
 */
public class JFrameBuscaLocador extends javax.swing.JFrame {

    /**
     * Creates new form JFrameBuscaLocador
     */
    public JFrameBuscaLocador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Número de Registro do Locador que se deseja buscar os dados");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        try {
            ...
            JFrameMostraLocador mostraLocador = new JFrameMostraLocador();
            mostraLocador.setLocationRelativeTo(null);
            mostraLocador.setVisible(true);
            mostraLocador.inicializaCampos((Locador) locador.consultaLocador(numRegistro,locador.criaArrayLocador()));
        } catch (IOException e) {
