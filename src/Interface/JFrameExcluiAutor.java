 ...
 * @author yuri-
 */
public class JFrameExcluiAutor extends javax.swing.JFrame {

    /**
     * Creates new form JFrameExclui
     */
    public JFrameExcluiAutor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Número de Registro do Autor que se deseja excluir do sistema");
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        try {
            autor.excluiAutor(numRegistro,autor.criaArrayAutor());
        } catch (IOException e) {
