 ...
 * @author yuri-
 */
public class JFrameBuscaAlteraAutor extends javax.swing.JFrame {

    /**
     * Creates new form JFrameAlteraAutor
     */
    public JFrameBuscaAlteraAutor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Número de Registro do Autor que se deseja alterar os dados");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        try {
            ...
            JFrameAlteraAutor alteracao = new JFrameAlteraAutor();
            alteracao.setLocationRelativeTo(null);
            alteracao.setVisible(true);
            alteracao.inicializaCampos((Autor)autor.consultaAutor(numRegistro, autor.criaArrayAutor()));
        } catch (IOException e) {
